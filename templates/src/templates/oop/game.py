...
def game(name):
    ...
    #Gnomos
    gnomo1 = kobold('kobold_gnomo', dungeon.find_free_tile() ,'G',50)
    gnomo2 = knoker('knoker_gnomo2', dungeon.find_free_tile() ,'Ĝ',100)
    gnomo3 = spriggan('spriggan_gnomo', dungeon.find_free_tile() ,'ğ',200)
    #Items
    ...
    while dungeon.level >= 0:
        ...
        print(dungeon.are_connected(pickaxe.loc(),player1.loc()))
